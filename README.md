...
## План ДЗ№6
 ...
 - Сделал балансировку нагрузки через ngin - otus.nt33.ru
 ...
 - Проблемы которые я должен был встретить по методички меня обошли стороной.


### Примечание к ДЗ№6
Как получить доступ через бастион хоста
```
  connection {
      type         = "ssh"
      user         = "ntikhomirov"
